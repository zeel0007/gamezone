    ...
    return (
        <main>
            <header className="page-header reveal" style={{
                ...
                textAlign: 'center',
                background: `linear-gradient(to bottom, var(--bg-dark), var(--bg-darker)), url('/assets/images/arcade.png') center/cover`,
            ...
            <section className="py-5">
                <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '40px' }}>
                    ...
                    <div className="game-card reveal" style={{ background: 'var(--bg-card)', borderRadius: '20px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)', position: 'relative' }}>
                        <img src="/assets/images/bowling.png" alt="Neon Bowling" style={{ width: '100%', height: '250px', objectFit: 'cover', borderBottom: '3px solid var(--primary-color)' }} />
                    ...
                    <div className="game-card reveal" style={{ transitionDelay: '0.1s', background: 'var(--bg-card)', borderRadius: '20px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)', position: 'relative' }}>
                        <img src="/assets/images/trampoline.png" alt="Trampoline Park" style={{ width: '100%', height: '250px', objectFit: 'cover', borderBottom: '3px solid var(--primary-color)' }} />
                        <div className="game-info" style={{ padding: '30px' }}>
                    ...
                    <div className="game-card reveal" style={{ transitionDelay: '0.2s', background: 'var(--bg-card)', borderRadius: '20px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)', position: 'relative' }}>
                        <img src="/assets/images/arcade.png" alt="Arcade Games" style={{ width: '100%', height: '250px', objectFit: 'cover', borderBottom: '3px solid var(--primary-color)' }} />
                        <div className="game-info" style={{ padding: '30px' }}>
                    ...
                    <div className="game-card reveal" style={{ background: 'var(--bg-card)', borderRadius: '20px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)', position: 'relative' }}>
                        <img src="/assets/images/arcade.png" alt="VR Games" style={{ width: '100%', height: '250px', objectFit: 'cover', borderBottom: '3px solid var(--primary-color)' }} />
                        <div className="game-info" style={{ padding: '30px' }}>
                    ...
                    <div className="game-card reveal" style={{ transitionDelay: '0.1s', background: 'var(--bg-card)', borderRadius: '20px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)', position: 'relative' }}>
                        <img src="/assets/images/trampoline.png" alt="Kids Play Zone" style={{ width: '100%', height: '250px', objectFit: 'cover', borderBottom: '3px solid var(--primary-color)' }} />
                        <div className="game-info" style={{ padding: '30px' }}>
